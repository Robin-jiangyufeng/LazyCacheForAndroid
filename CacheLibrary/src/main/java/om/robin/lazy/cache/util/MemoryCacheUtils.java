 ...
 *******************************************************************************/
package om.robin.lazy.cache.util;
...
import com.lazy.library.cache.memory.EntryRemovedProcess;
import com.lazy.library.cache.memory.MemoryCache;
import com.lazy.library.cache.memory.SizeOfCacheCalculator;
import com.lazy.library.cache.memory.impl.EntryRemovedProcessMemoryCache;
import com.lazy.library.cache.memory.impl.LruMemoryCache;
import com.lazy.library.cache.memory.impl.SizeOfMemoryCache;
import com.lazy.library.util.bitmap.ImageSize;
...
public final class MemoryCacheUtils {
	 ...
	 * only you didn't set
	 * {@link keyLoaderConfiguration.Builder#denyCachekeyMultipleSizesInMemory()
	 * denyCachekeyMultipleSizesInMemory()} option in
	 * {@linkplain keyLoaderConfiguration configuration}
	 * 
	 * @param <V>
	 */
